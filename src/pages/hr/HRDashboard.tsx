    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <div className="animate-slide-up stagger-1">
          <KPICard title="Total Leads" value={data?.totalLeads ?? 0} icon={Users} link="/hr/leads" />
        </div>
        <div className="animate-slide-up stagger-2">
          <KPICard title="Active Leads" value={data?.activeLeads ?? 0} icon={TrendingUp} link="/hr/leads" />
        </div>
        <div className="animate-slide-up stagger-3">
          <KPICard title="Closed Leads" value={data?.closedLeads ?? 0} icon={CheckCircle2} variant="success" link="/hr/closed-leads" />
        </div>
        <div className="animate-slide-up stagger-4">
          <KPICard title="Lost Leads" value={data?.lostLeads ?? 0} icon={XCircle} variant="danger" />
        </div>
        <div className="animate-slide-up stagger-5">
          <KPICard title="Total Calls" value={data?.totalCalls ?? 0} icon={PhoneCall} />
        </div>
      </div>
