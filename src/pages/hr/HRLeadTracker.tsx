...
import { useHRLeads } from '@/hooks/useApi';
...
const statusColors: Record<string, string> = {
  ...
  Reshedule: 'bg-orange-100 text-orange-700',
...
export default function HRLeadTracker() {
  ...
  const activeCount = leads.filter((l: any) => !['Closed', 'Lost'].includes(l.status)).length;
      ...
      <div className="flex flex-col sm:flex-row gap-3 animate-slide-up stagger-5">
        ...
        <Select value={statusFilter} onValueChange={setStatusFilter}>
          ...
          <SelectContent>
            ...
            <SelectItem value="Reshedule">Reschedule</SelectItem>
