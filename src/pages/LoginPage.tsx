    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          {/* Demo credentials */}
          <div className="rounded-lg border border-border bg-accent/50 p-4 mb-6">
            <p className="text-sm font-medium text-foreground mb-3">Demo Accounts</p>
            <div className="space-y-2">
              <button
                type="button"
                onClick={() => fillCredentials('admin@insurelead.com', 'admin123')}
              ...
              >
                ...
                <span className="text-muted-foreground text-xs">admin@insurelead.com</span>
              </button>
              <button
                type="button"
                onClick={() => fillCredentials('mike@insurelead.com', 'sdr123')}
                className="w-full flex items-center justify-between rounded-md border border-border bg-background px-3 py-2 text-sm hover:bg-accent transition-colors"
              >
